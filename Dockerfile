...
# Install repository {{{
COPY --chown=1000:1000 . /opt/fmc_repository/ms-inventory-management
RUN ln -sf /opt/fmc_repository/ms-inventory-management /opt/fmc_repository/CommandDefinition/ms-inventory-management
# }}}
